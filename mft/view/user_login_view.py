...
class Ui_Form(object):
    ...
    # verify ( when forget username /password in sign in view)

    # -*- coding: utf-8 -*-

    ################################################################################
    ## Form generated from reading UI file 'verify_viewyhTnbb.ui'
    ##
    ## Created by: Qt User Interface Compiler version 5.14.1
    ##
    ## WARNING! All changes made in this file will be lost when recompiling UI file!
    ...
    class Ui_Form(object):
        def setupUi(self, Form):
            ...
            self.label_2 = QLabel(self.widget)
            self.label_2.setObjectName(u"label_2")
            self.label_2.setGeometry(QRect(50, 450, 300, 20))
            font3 = QFont()
        ...
        def retranslateUi(self, Form):
            Form.setWindowTitle(QCoreApplication.translate("Form", u"Form", None))
            self.label.setText(QCoreApplication.translate("Form", u"\ue119", None))
            self.lineEdit.setPlaceholderText(QCoreApplication.translate("Form", u"  Phone Number", None))
            self.lineEdit_2.setPlaceholderText(QCoreApplication.translate("Form", u"  Verify Code", None))
            self.pushButton.setText(QCoreApplication.translate("Form", u"Verify", None))
            self.label_2.setText(QCoreApplication.translate("Form", u"A code will be sent to your phone number", None))
        # retranslateUi
